...
namespace ITUniver.Calc.DB.Repositories
{
    public class DBRepository : IHistoryRepository
    {
        ...
        string connectionstring = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\C#\BlockchainCalculator\ITUniver.Calc.DB\App_Data\CalcDB.mdf;Integrated Security=True";
